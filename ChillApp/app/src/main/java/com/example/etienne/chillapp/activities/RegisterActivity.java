...
public class RegisterActivity extends Activity {
	...
	//	});
		...
		btnAppShare.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				String name = "hang"; //userName.getText().toString();
        ...
        btnContact = (Button) findViewById(R.id.button);
	...
	public String registerGCM() {
		...
		if (TextUtils.isEmpty(regId)) {
			...
			Log.d("RegisterActivity",
                    "RegisterID naar server gestuurd is gelukt - regId: "
                            + regId);
		} else {
			Toast.makeText(getApplicationContext(),
                    "RegisterID is al op de server " + regId,
                    Toast.LENGTH_LONG).show();
		}
		return regId;
	}
	...
	private String getRegistrationId(Context context) {
		final SharedPreferences prefs = getSharedPreferences(
				Main1Activity.class.getSimpleName(), Context.MODE_PRIVATE);
